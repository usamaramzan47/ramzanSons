...
function Sidebar() {
    ...
    return (
        <div className={`left_side sticky h-screen top-0 transition-all duration-200 bg-sidebar dark:bg-slate-800 border-r ${isSidebarCollapsed ? 'w-0 p-0 overflow-hidden' : 'w-64 p-4 '} `} >
